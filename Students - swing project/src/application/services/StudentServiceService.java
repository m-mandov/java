 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://services.application/", wsdlLocation = "http://pc:8080/StudentWebService/StudentServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://services.application/", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://pc:8080/StudentWebService/StudentServiceService?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://services.application/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.application/", "StudentServicePort"), StudentService.class, features);
    }
